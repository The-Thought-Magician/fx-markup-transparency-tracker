...
// Auth: current user's subscription plan. User-scoped, not org-scoped.
// Always returns a sensible default (free plan) even if Stripe env vars are
// missing — billing must never crash when Stripe isn't configured.
